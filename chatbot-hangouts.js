//======================================================
// TODO : empêcher le bot de répéter le dernier message qu'il a envoyé
//======================================================
...
var messagesSelector = ".tL8wMe";
var messageInputSelector = ".vE";
var sendButtonSelector = ".NQ0ZIe";
var participantsSelector = ".vT";
var messageSenderSelector = ".UR > span";
var showParticipantsListSelector = ".dwrYTb.PK";
var cancelParticipantsListSelector = ".UhDpP.cmX6We.TTnd8c.ny1kd.z-b-G";
...
Bot.prototype = {
    ...
    start: function()
    {
        ...
        this.monitorForNewMessage(callbacks);
     ...
     */
    monitorForNewMessage: function(callbacks)
    {
        var that = this;
        ...
        setTimeout(function()
        {
            that.monitorForNewMessage(callbacks);
        }, 1000);
    },
    ...
    search: function(message)
    {
        ...
        if (matches != null)
        {
            ...
            var request = gapi.client.search.cse.list({
                'q': keywords,
                'cx': '003020110413416694432:_exuiff-o5m'
            });

            request.then(function(response) {
                that.sendMessage(response.result.items[0].link);
            }, function(reason) {
...
function makeRequest(request) {
    ...
    request.then(function(response) {
        appendResults(response.result.items[0].link);
    }, function(reason) {
        console.log('Error: ' + reason.result.error.message);
    });
}
...
function init() {
    gapi.client.setApiKey('AIzaSyB1yvPIuPGC_nglxZaLP3wPAOsK0pa_UjU');
